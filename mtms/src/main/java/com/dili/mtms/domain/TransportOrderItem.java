 ...
 */
@Table(name = "`transport_order_item`")
public interface TransportOrderItem extends IBaseDomain {
    @Id
    ...
    @FieldDef(label="运输单id")
    @EditMode(editor = FieldEditor.Number, required = false)
    Long getTransportOrderId();

    void setTransportOrderId(Long transportOrderId);
